...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    VALUES ($guest_id, $room_num, '$check_in', '$check_out','Online', 'Confirmed')");
    ...
    echo "<p style='color: green; font-weight: bold;'>Booking successful with reservation number $res_id! Room $room_num assigned. Please remeber your reservation number.</p>";
}
